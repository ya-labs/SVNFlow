...
Quando a tarefa pedir economia de contexto, implementação por issue preparada ou redução de leituras amplas, siga o padrão organizacional documentado no YABook.
